...
pa <- ggplot(ls.tabla, aes(x=Register, y=lsmean, linetype=clusters)) + 
  geom_errorbar(aes(ymin = lower.CL, ymax = upper.CL),
                width = 0.2,col="#1777CF") +
  geom_line(col="#1777CF") +
  geom_point(aes(y = lsmean), size = 3, 
             shape = 21, col="#1777CF",fill = "white") +
  labs(x = "Week", y = bquote("Mean" %+-% "2SE"),
       title = "Amotivation",linetype='Group') +
  theme_bw() +
  theme(plot.title = element_text(colour = "black",face='bold')) +
  scale_x_continuous(breaks=c(1:14),
                     labels=paste0(1:14)) +
  scale_linetype_discrete(name='Group',breaks=c('A','B'),
...
pb <- ggplot(ls.tabla, aes(x=Register, y=lsmean, linetype=clusters)) + 
  ...
  geom_point(aes(y = lsmean), size = 3, 
             shape = 21, col="#1777CF",fill = "white") +
  labs(x = "Week", y = bquote("Mean" %+-% "2SE"),
       title = "Extrinsic Regulation: Material") +
  theme_bw() +
  theme(plot.title = element_text(colour = "black",face='bold')) +  
  scale_x_continuous(breaks=c(1:14),
                     labels=paste0(1:14)) +
...
pc <- ggplot(ls.tabla, aes(x=Register, y=lsmean, linetype=clusters)) + 
  ...
  geom_point(aes(y = lsmean), size = 3, 
             shape = 21, col="#1777CF",fill = "white") +
  labs(x = "Week", y = bquote("Mean" %+-% "2SE"),
       title = "Extrinsic Regulation: Social",linetype='Group') +
  theme_bw() +
  theme(plot.title = element_text(colour = "black",face='bold')) +  
  scale_x_continuous(breaks=c(1:14),
                     labels=paste0(1:14)) +
...
pd <- ggplot(ls.tabla, aes(x=Register, y=lsmean, linetype=clusters)) + 
  ...
  geom_line(col="#1777CF") +
  geom_point(aes(y = lsmean), size = 3, 
             shape = 21, col="#1777CF",fill = "white") +  labs(x = "Week", y = bquote("Media" %+-% "2EE"),
       title = "Identified Regulation",linetype='Group') +
  theme_bw() +
  theme(plot.title = element_text(colour = "black",face='bold')) +  
  scale_x_continuous(breaks=c(1:14),
                     labels=paste0(1:14)) +
...
pe <- ggplot(ls.tabla, aes(x=Register, y=lsmean, linetype=clusters)) + 
  ...
  geom_point(aes(y = lsmean), size = 3, 
             shape = 21, col="#1777CF",fill = "white") +
  labs(x = "Week", y = bquote("Mean" %+-% "2SE"),
       title = "Intrinsic Motivation",linetype='Group') +
  theme_bw() +
  theme(plot.title = element_text(colour = "black",face='bold')) +  
  scale_x_continuous(breaks=c(1:14),
                     labels=paste0(1:14)) +
...
pf <- ggplot(ls.tabla, aes(x=Register, y=lsmean, linetype=clusters)) + 
  ...
  geom_point(aes(y = lsmean), size = 3, 
             shape = 21, col="#1777CF",fill = "white") +
  labs(x = "Week", y = bquote("Mean" %+-% "2SE"),
       title = "Introjected Regulation",linetype='Group') +
  theme_bw() +
  theme(plot.title = element_text(colour = "black",face='bold')) +  
  scale_x_continuous(breaks=c(1:14),
                     labels=paste0(1:14)) +
...
pg <- ggplot(ls.tabla, aes(x=Register, y=lsmean, linetype=clusters)) + 
  ...
  geom_point(aes(y = lsmean), size = 3, 
             shape = 21, col="#1777CF",fill = "white") +
  labs(x = "Week", y = bquote("Mean" %+-% "2SE"),
       title = "Subjective Performance",linetype='Group') +
  theme_bw() +
  theme(plot.title = element_text(colour = "black",face='bold')) +  
  scale_x_continuous(breaks=c(1:14),
                     labels=paste0(1:14)) +
...
ph <- ggplot(ls.tabla, aes(x=Register, y=lsmean, linetype=clusters)) + 
  ...
  geom_point(aes(y = lsmean), size = 3, 
             shape = 21, col="#1777CF",fill = "white") +
  labs(x = "Week", y = bquote("Mean" %+-% "2SE"),
       title = "Cumulative Absences",linetype='Group') +
  theme_bw() +
  theme(plot.title = element_text(colour = "black",face='bold')) +
  scale_x_continuous(breaks=c(1:14),
                     labels=paste0(1:14)) +
  scale_linetype_discrete(name='Group',breaks=c('A','B','C'),
...
pi <- ggplot(ls.tabla, aes(x=Register, y=lsmean, linetype=clusters)) + 
  ...
  geom_point(aes(y = lsmean), size = 3, 
             shape = 21, col="#1777CF",fill = "white") +
  labs(x = "Week", y = bquote("Mean" %+-% "2SE"),
       title = "# conections",linetype='Group') +
  theme_bw() +
  theme(plot.title = element_text(colour = "black",face='bold')) +
  scale_x_continuous(breaks=c(1:14),
                     labels=paste0(1:14)) +
...
pj <- ggplot(ls.tabla, aes(x=Register, y=lsmean, linetype=clusters)) + 
  ...
  geom_point(aes(y = lsmean), size = 3, 
             shape = 21, col="#1777CF",fill = "white") +
  labs(x = "Week", y = bquote("Mean" %+-% "2SE"),
       title = "Time between connections",linetype='Group') +
  theme_bw() +
  theme(plot.title = element_text(colour = "black",face='bold')) +
  scale_x_continuous(breaks=c(1:14),
                     labels=paste0(1:14)) +
...
ggplot(datoscompletos,aes(x=clusters,y=Nota)) +
  geom_boxplot(fill='#1777CF', alpha=.3,outliers=FALSE) +
...
# Comparación de clústers: Rendimiento subjetivo, absentismo y razones de absentismo
...
rownames(RESULTADOS) <- c('Objective Perf.','Subjective Perf.','Absenteeism','Planification','Teaching M.','Learning M.','Course P.','External F.')
colnames(RESULTADOS) <- c(rep(c('M','SD'),2),'t (df); p value','Lower B.','Upper B.')
RESULTADOS %>% kable() %>% kable_styling("striped") %>%
  add_header_above(c("","Group A" = 2, "Group B" = 2,"Test" = 1, "95% CI difference"=2),color="black")  %>% 
